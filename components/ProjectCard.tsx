  ...
  return (
    ...
    >
      ...
      <div className="p-8 flex-1 flex flex-col relative">
        ...
        <p className="text-gray-400 text-sm mb-8 flex-1 leading-relaxed line-clamp-3 whitespace-pre-wrap">
          <MarkdownText text={project.description} />
        </p>

        <div className="flex flex-row-reverse sm:flex-row items-center justify-end sm:justify-start gap-4 pt-6 border-t border-white/5 mt-auto">
          {project.github && (
            <div className="text-gray-400 hover:text-[#0F4C81] transition-colors p-1 ml-auto">
          ...
          <div className="flex items-center gap-2 text-sm font-bold text-[#0F4C81] group-hover:text-[#2B9B78] transition-all duration-300 font-medium w-full sm:w-auto mt-2 sm:mt-0">
            View Case Study
